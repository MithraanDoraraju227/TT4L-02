...
$comments = [];
$sql = "SELECT rating, comment FROM comments WHERE topic = 'FCA' AND sector = 'Classrooms' ";
...
$averageRating = 0;
$sql = "SELECT AVG(rating) AS avg_rating FROM comments WHERE topic = 'FCA' AND sector ='Classrooms' ";
$result = $conn->query($sql);
...
<body>
    ...
    <ul>
        <div class="icon">
            <h2 class="logo">FCA - Classrooms</h2>
        </div>
        ...
        <li>
            ...
            <ul class="dropdown">
                <li><a href="fca_scroom.php">Classrooms</a></li>
    ...
    <div class="average-rating" style="color: white;">
        <?php if ($averageRating): ?>
            Average Rating FCA - Classrooms: <?php echo number_format($averageRating, 2); ?> / 5
        <?php else: ?>
            No ratings available for FCA - Classrooms.
        <?php endif; ?>
    </div>  
